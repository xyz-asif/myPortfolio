      ...
      <AnimatePresence mode="wait">
        {isLoading && (
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center text-center px-4 w-full max-w-sm mx-auto">
              {/* Logo/Brand */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, ease: [0.4, 0.0, 0.2, 1] }}
                className="mb-12 sm:mb-16" // Responsive margin
              >
                <h1 className="text-xl sm:text-2xl font-light tracking-tight text-black font-serif mb-3">Asif Shaik</h1>
                <motion.div
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  transition={{ delay: 0.3, duration: 0.8, ease: [0.4, 0.0, 0.2, 1] }}
                  className="h-px bg-black w-12 sm:w-16 mx-auto" // Responsive width
              ...
              <motion.div
                ...
                className="relative w-full max-w-xs" // Full width with max constraint
              >
                {/* Clean Progress Bar */}
                ...
                <motion.div
                  ...
                  className="text-xs font-light text-gray-400 mt-4 tracking-wider text-center"
                >
                  {Math.round(progress)}%
                </motion.div>
              </motion.div>
              ...
              <motion.div
                ...
                className="mt-8 sm:mt-12" // Responsive margin
              >
